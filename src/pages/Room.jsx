          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-900 bg-opacity-50 dark:bg-opacity-70">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-2xl p-6 mx-4 my-10">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  <label htmlFor="contact" className="block text-sm font-medium text-gray-700 dark:text-gray-300 text-left">Date</label>
                  <input
                    type="Date"
                    id="date"
                    name="date"
                ...
                <div className="mb-4">
                  <label htmlFor="room" className="block text-sm font-medium text-gray-700 dark:text-gray-300 text-left">Role</label>
                  <select
                    id="room"
                    name="room"
                    value={formData.role}
                ...
                <div className="mb-4">
                  <label htmlFor="status" className="block text-sm font-medium text-gray-700 dark:text-gray-300 text-left">Role</label>
                  <select
                    id="status"
                    name="status"
                    value={formData.role}
                ...
                <div className="mb-4">
                  <label htmlFor="email" className="block text-sm font-medium text-gray-700 dark:text-gray-300 text-left">Pricing</label>
                  <input
                    type="text"
                    id="pricing"
                    name="pricing"
